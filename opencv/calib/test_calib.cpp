...
#define LOG cerr<<">>> "<<__FILE__<<"["<<__LINE__<<"]:"<<__func__<<"();"<<endl;
...
int main(int argc, char *argv[]) {
	...
	line(test,	Point(cube_image_points[0].x,cube_image_points[0].y),
			Point(cube_image_points[1].x,cube_image_points[1].y), Scalar(0,0,255),9);
	line(test,	Point(cube_image_points[0].x,cube_image_points[0].y),
			Point(cube_image_points[2].x,cube_image_points[2].y), Scalar(0,255,0),9);
	line(test,	Point(cube_image_points[0].x,cube_image_points[0].y),
			Point(cube_image_points[3].x,cube_image_points[3].y), Scalar(255,0,0),9);
